...
from rl_projects.leaderboard.autoagents.agent_wrapper import AgentWrapperFactory, AgentError, TickRuntimeError
from rl_projects.leaderboard.envs.sensor_interface import SensorReceivedNoData
...
class ScenarioManager(object):
    ...
    def my_load_scenario(self, scenario, ego_vehicles, route_index, rep_number):
        """
        Load a new scenario
        """
        GameTime.restart()
    ...
    def _tick_scenario(self):
        ...
        if self._timestamp_last_run < timestamp.elapsed_seconds and self._running:
            ...
            if self.tick_count > 3000:
                raise TickRuntimeError("RuntimeError, tick_count > 1500")
    ...
    def _set_observation_image(self, image, cam_type):
        self.observation_buffer.append((cam_type, image))
