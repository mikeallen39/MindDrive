...
CONFIG_PATH="${MINDDRIVE_CONFIG_PATH:-${ROOT_DIR}/adzoo/minddrive/configs/minddrive_qwen25_3B_infer.py}"
CKPT_PATH="${MINDDRIVE_CKPT_PATH:-${ROOT_DIR}/ckpts/minddrive_3b_rltrain.pth}"
TEAM_CONFIG="${CONFIG_PATH}+${CKPT_PATH}"
CHECKPOINT_DIR="${MINDDRIVE_CHECKPOINT_DIR:-minddrive_3b_results}"
CHECKPOINT_ENDPOINT="${CHECKPOINT_DIR}/$(basename "${ROUTES_BASENAME}").json"
SAVE_DIR="${MINDDRIVE_SAVE_DIR:-eval_minddrive_3b_traj}"
