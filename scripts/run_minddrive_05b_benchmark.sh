...
TEAM_CONFIG="Bench2DriveZoo/adzoo/minddrive/configs/minddrive_qwen2_05B_infer.py+Bench2DriveZoo/ckpts/minddrive_rltrain.pth"
CHECKPOINT_ENDPOINT="minddrive_05b_results/$(basename "${ROUTES_BASENAME}").json"
SAVE_PATH="${BENCH_DIR}/eval_minddrive_05b_traj"
PLANNER_TYPE="traj"
IS_BENCH2DRIVE="True"
